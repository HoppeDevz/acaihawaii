...
import anim from '../../assets/13398-money-stack.gif';

export default function SelectMethod() {
    const route = useRoute();
    const data = route.params.order.data[0];
    console.log(data);
    ...
    function moneySelectMethodHandler() {
        ...
        navigation.navigate("MoneyPaymentCart", info)
    }
            ...
            <View style={styles.containermaster} >
                ...
                <View style={styles.container}>
                    <TouchableOpacity style={styles.buttonmoney} onPress={moneySelectMethodHandler} > 
                        ...
                        <Feather name="dollar-sign" size={16} color="#ffff" /> Dinheiro
                        </Text>
                    </TouchableOpacity>
